...
def estep(X: np.ndarray, mixture: GaussianMixture) -> Tuple[np.ndarray, float]:
    ...
    post = post / pre_exp  # PDF - Final Normal matrix: will be (n, K)


    # Compute posterior probability (data point u belongs to cluster j)
    numerator = post * pi
    ...
    # Log-likelihood (sum over all clusters)
